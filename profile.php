...
$_REQUEST($user,$pass);
$sql = "SELECT messageid, usernamemsg, date, message FROM messages WHERE usernamemsg=$user";
$sql2 = "SELECT relationshipid, usernamerel, friendname from relationships WHERE usernamerel=$user";
$sql3 = "SELECT username, password, displayname where username=$user";
...
<h2> List of friends<h2>
	...
	?>			
				<tr>
				    <td><?php echo "<a href=friendmsg.php>$row['displayname']</a>";?></td>
				</tr>
				tr>
